...
public class ActivityLoginAuth extends BaseActivity implements View.OnClickListener {
    ...
    private static final long TIME_UPDATE_TOKEN = 15 * 1000;
    ...
    private void updateSeconds() {
        String sourceString = "Simply Tap Match within " + timeRemainingInSec + " seconds";
...
//            }
    ...
    private void sendCode(int index) {
        ...
        if (index == rectIndex) {
            selectCode(/*zaCode*/mMyApp.getAndroidId());
        } else {
            selectCode("-081057");
        }
    }
