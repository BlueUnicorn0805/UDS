...
public class OpenDeliveriesListAdapter extends BaseAdapter {

    private Context mContext;
    private List<OpenDeliveryInfo> mDataList;

    public OpenDeliveriesListAdapter(Context mContext, List<OpenDeliveryInfo> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get Item Data
        OpenDeliveryInfo itemInfo = (OpenDeliveryInfo) getItem(position);
