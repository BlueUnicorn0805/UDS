...
public class CheckUsernameFragment extends BaseFragment implements View.OnClickListener {

    public static CheckUsernameFragment newInstance(String text) {
        CheckUsernameFragment mFragment = new CheckUsernameFragment();
