...
public class OpenDeliveryInfo implements Parcelable {
    ...
    // -------------- Time Information
    public String getMaxLocalTime() { return MaxLocalTime; }
    public void setMaxLocalTime(String maxLocalTime) { MaxLocalTime = maxLocalTime; }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(MaxLocalTime);
