...
public class DateUtil {
    ...
    public static final String DATE_FORMAT_15 = "EEE h:mm a";
    ...
    public static final String DATE_FORMAT_20 = "EEE MM-dd h:mm a";                // Aug 21 11:15 AM,

    public static final String DATE_FORMAT_21 = "EEE, MMM d";

    public static final String DATE_FORMAT_22 = "MMM dd h:mm a";                // Aug 21 11:15 AM,
    ...
    public static final String DATE_FORMAT_39 = "MMM dd yyyy hh:mma";
    public static final String DATE_FORMAT_40 = "yyyy-MM-dd hh:mm a";
    ...
    public static String toStringFormat_36(Date date) {
        if (date == null)
            return "";
        return dateToString(date, DATE_FORMAT_36);
    }

    public static String toStringFormat_39(Date date) {
        if (date == null)
            return "";
        return dateToString(date, DATE_FORMAT_39);
    }

    public static String toStringFormat_40(Date date) {
        if (date == null)
            return "";
        return dateToString(date, DATE_FORMAT_40);
    }
    ...
    public static Date parseDataFromFormat39(String dateString) {
        Date retDate = new Date();
        SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT_39);
        try {
            retDate = format.parse(dateString);
        } catch (ParseException e) {
            e.printStackTrace();
    ...
    public static Date parseDataFromFormat40(String dateString) {
        Date retDate = new Date();
        SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT_40);
        try {
            retDate = format.parse(dateString);
        } catch (ParseException e) {
            e.printStackTrace();
